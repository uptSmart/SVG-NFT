    ...
    Ownable
{
    ...
    /**
     * @dev creator the contract of ERC721Tradable
     ...
     * @dev Mints a token to an address with a tokenURI,
            the tokenURI are set to individual paths of the SVG image. (SVF-NFTs). 
     * @param _to address of the future owner of the token
     * @param _tokenId  tokenId of the nft
     * @param _tokenUri tokenURI of the nft 
     */
    function mintTo(address _to,uint256 _tokenId,string memory _tokenUri) public onlyOwner {

        idToTokenUri[_tokenId] = _tokenUri;
     ...
     * @param _operator  operate on all of `owner` tokens
     */
